...
(function () {
    ...
    function initScrollReveal() {
      ...
      const targets = [
        ...
        { sel: '.gov-integrations-wrap .gov-section-sub',  cls: 'pv-reveal', delay: '0.14s' },
      ...
      /* Gov-integrations is now its own section, so step1Only is empty */
    ...
    function initLiveBadges() {
      $$('.gov-badge.live').forEach(badge => {
        if (badge.querySelector('.gov-live-dot')) return;
